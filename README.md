...
| Name               | Function                                                                 |
|------------------------|--------------------------------------------------------------------------|
| Ablation experiment.py   | Integrate multiple classifiers (CatBoost / Random Forest / SVM) to achieve sample sampling and training with labeled noise |
| final model.py | Core model: CatBoost custom loss function + PFS data preprocessing + hyperparameter tuning + visualization |
...
**2. Core Step**  
   ...
   Step4: Run DCA and calibration.py to generate the DCA and calibration results.  
   Step5: Use the results generated by the above code to run the R code for plotting.  


**3. Output**
--Accuracy, sensitivity, specificity, precision, F1 score   
<img width="300" height="300" alt="image" src="https://github.com/user-attachments/assets/8721f54d-3d39-4f68-8401-d8495fb6b091" />

--Accuracy AUC Curve  

<img width="300" height="300" alt="PFS AUC" src="https://github.com/user-attachments/assets/42ef892c-671e-4d7a-b03c-ba42a04f4838" />


--Top 10 Key Characteristics  

<img width="300" height="300" alt="image" src="https://github.com/user-attachments/assets/0361afa6-9c5e-45a9-b503-20b2821d4791" />


--Comparison results with other mainstream machine learning models  

<img width="300" height="300" alt="PFS test model Comparison" src="https://github.com/user-attachments/assets/51253761-3bf5-4873-af94-ac7db927cd55" />


--DCA and calibration curve  

<img width="300" height="300" alt="PFS calibration" src="https://github.com/user-attachments/assets/2a5046f5-c999-4f74-a7c1-9fb71dab030e" />

--KM curve

<img width="300" height="300" alt="PFS EV KM" src="https://github.com/user-attachments/assets/a362d063-79e1-4672-9618-cf466db06917" />
